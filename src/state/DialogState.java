...
public class DialogState extends GameState {
    ...
    public DialogState(GameStateManager gsm, Npc npc) {
        ...
        mgForStart = new ArrayList<Button>(Arrays.asList(dl.start1, dl.start2, dl.start3, dl.start4, dl.start5));
        mgForNpc1 = new ArrayList<Button>(Arrays.asList(dl.wm1,dl.wm2));
        mgForNpc2 = new ArrayList<Button>(Arrays.asList(dl.ol1));
        mgForNpc3 = new ArrayList<Button>(Arrays.asList(dl.gl1, dl.gl2));
        mgForNpc4 = new ArrayList<Button>(Arrays.asList(dl.je1, dl.je2));
        mgForNpc5 = new ArrayList<Button>(Arrays.asList(dl.sd1, dl.sd2,dl.sd3));
        mgForOldman = new ArrayList<Button>(Arrays.asList(dl.ol2));
    }
    ...
    public void render(Graphics2D g) {
        ...
        if (isStart) {
            ...
            // System.out.println("Start Talked");
